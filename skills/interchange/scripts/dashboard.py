...
def task_card(item, attempts):
    ...
    content = ('<details class="task-card"><summary class="task-summary">'
               ...
               + '<span class="summary-detail">' + esc(summary_detail) + '</span></summary>'
