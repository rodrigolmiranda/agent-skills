...
9. **Close or correct.** Send one consolidated bounded correction; re-review the changed findings/impact, preserve accepted areas. Record unrelated bugs for later prioritization. Update issues/project, then return an explicit verdict and next owner. No automatic next slice.
