...
2. Keep organization-specific authority in local project instructions. Delivery-orchestrator owns generic workflow and semantic templates; Interchange owns transport and execution records. Neither portable core requires an external vault or personal checkout.
