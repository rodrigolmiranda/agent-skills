...
When project governance selects an adapter, load its configured GitHub breakdown and coordinator procedure. Its adopted task/checklist definitions constrain generic examples; preserve accepted deviations.
