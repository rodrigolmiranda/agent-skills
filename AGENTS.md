...
Reusable skills live under `skills/<name>/SKILL.md`. For new Interchange assignments, start at `skills/interchange/SKILL.md`; workflow, verification, transport and editable profiles are routed there. Legacy policy/operating-model files apply only to unreconciled assignments. Existing generated views describe that legacy policy until explicitly regenerated.
