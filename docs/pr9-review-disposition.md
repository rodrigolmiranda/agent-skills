...
| Scheduling ceremony | One complete current receipt where adopted, incremental changed-item checks, full scans for takeover/scope/stale coverage. Explicit programme adoption holds remain binding. |
...
| Waiting versus blocked | Six board columns distinguish a progressing owned prerequisite from intervention required. |
